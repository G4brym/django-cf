...
def test_admin_login_page_loads(d1_web_server):
    """Test that the admin login page loads correctly."""
    admin_url = f"{d1_web_server.base_url}/admin/login/"
...
def test_admin_login_failed_wrong_password(d1_web_server):
...
def test_admin_logout(d1_web_server):
    ...
    login_url = f"{d1_web_server.base_url}/admin/login/"
    logout_url = f"{d1_web_server.base_url}/admin/logout/"
    admin_dashboard_url = f"{d1_web_server.base_url}/admin/"
    client = requests.Session()
